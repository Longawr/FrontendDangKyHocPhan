...
import CourseRegistration.DAO.*;
import CourseRegistration.Main.App;
import CourseRegistration.POJO.*;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (currentCourseRegistration != null) {
            ...
            for (Course element : courseList) {
                element.setChecked(CourseattendDAO.getCourseattendByID(App.getCurrentStudent().getId(), element.getId()) != null);
                list.add(element);
            }
                ...
                while (c.next()) {
                    if (c.wasUpdated()) {
                        ...
                        if (updateCourse.isChecked()) {
                            ...
                            else if (Objects.equals(updateCourse.getMaxSlot(), updateCourse.getRegisterSlot())) {
